...
function imprimir() {
    ...
    printJS({
        ...
        style: 'table {border-collapse: collapse; width: 100% !important; margin: 0 auto;text-align: center;} th, td {border: 1px solid black; padding: 0px; margin: 0px; font-size:12px; text-align:center} body { text-align: center; }',
    });
}
