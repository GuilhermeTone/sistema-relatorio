                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->Cargo == 'admin')
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out font-medium rounded-lg text-sm px-1 pt-1 pb-1.5 text-center inline-flex items-center"
                            type="button">Menu<svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none"
...
<script>
    var TOKEN_CSRF = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
</script>
<script>
    var APP_URL = '{{ url('') }}';
</script>
