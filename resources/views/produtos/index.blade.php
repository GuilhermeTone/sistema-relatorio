        ...
        <div class="w-full shadow bg-white rounded mt-2">
            <div class="border-gray-200 w-full rounded bg-white overflow-x-auto">
                <div class="flex justify-end">
                    <button type="button" style="width: 10rem; height:2rem; margin-right: 15px" class="text-white bg-gray-800 mt-2 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium text-sm px-5 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 rounded-lg" onclick="adicionaProduto()">Incluir produto</button>
                </div>
                ...
                <table class="w-full leading-normal ">
                    ...
                    <tbody class="inputs-body">
                        <tr class="">
                            ...
                            <td class="py-4 px-6 border-b border-gray-200 text-gray-900 text-sm ">
                                <x-text-input id="quantidade[0]" class="block mt-1 w-full quantidade" type="text" name="quantidade[0]"
                                    required />
                            </td>
                           <td class="py-4 px-6 border-b border-gray-200 text-gray-900 text-sm ">
                                <div class="flex items-center">
                            ...
                            <td class="py-4 px-6 border-b border-gray-200 text-gray-900 text-sm ">
                                <div class="flex items-center justify-center">
                                    <button type="button" style="width: 10rem; height:2rem; margin-right: 15px; background-color:rgb(151, 5, 5)" class="text-white focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium text-sm px-5 mb-2 rounded-lg">Excluir produto</button>
                                </div>
                            </td>
                ...
                <button type="submit" id="btnsubmitproduto" style="width: 10rem; height:2rem; margin-left: 15px" class="text-white bg-gray-800 mt-2 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium text-sm px-5 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 rounded-lg">Salvar</button>
                </form>
            </div>
        </div>
    </body>
...
<script>var produtos = ('<?php echo json_encode($produtos); ?>');</script>
<script src="{{ asset('build/assets/pedidos/index.js') }}"></script>