...
<div id="default-modal" aria-hidden="true"
    class="hidden flex overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40">
