    ...
    <x-guest-layout>
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
             ...
             <div class="mt-4">
                <label for="countries" class="block mt-1 text-sm font-medium text-gray-900 dark:text-white">Loja</label>
            ...
            <div class="mt-4">
                <label for="countries" class="block mt-1 text-sm font-medium text-gray-900 dark:text-white">Cargo</label>
