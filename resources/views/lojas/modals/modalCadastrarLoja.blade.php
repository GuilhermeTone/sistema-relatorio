<!-- Main modal -->
<div id="default-modal-cadastra" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form method="POST" action="{{ route('criarLoja') }}" onsubmit="desabilita()">
            @csrf
            <div class="p-6 space-y-6">
                    <input type="hidden" name="idLoja" id="idLoja" required>
                    <div class="mt-4">
                        <x-input-label for="Loja" :value="__('Loja')" required/>
                        <x-text-input id="Nome" class="block mt-3 w-full quantidadeVerduras" type="text"
                            name="Nome" />
                    </div>
            </div>
